...
/**
 * <p>The <code>org.eclipse.titan.graph.utils</code> package contains classes that
 * implement some useful features on the module graph. Here is the cycke checking
 * class tests whether a given graph is a DAG. Also here is a class that makes
