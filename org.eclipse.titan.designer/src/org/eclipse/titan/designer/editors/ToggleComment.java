...
public class ToggleComment extends TextEditorAction {
	...
	private boolean isSelectionCommented(final ISelection selection) {
		...
		try {
			...
			ITypedRegion[] regions = TextUtilities.computePartitioning(document, documentPartitioning, block.getOffset(),
	...
	public void update() {
		...
		boolean isEnabled = (operationTarget != null && operationTarget.canDoOperation(ITextOperationTarget.PREFIX) && operationTarget
