 ...
 */
public final class ASN1_Choice_Type_V4 extends ASN1_Choice_Type {

	public ASN1_Choice_Type_V4(final Block aBlockV4) {
		super(aBlockV4);
	}

	@Override
	public IASN1Type newInstance() {
		return new ASN1_Choice_Type_V4(mBlock);
	}

	@Override
	protected void parseBlockChoice() {
		ASN1Parser2 parserV4 = null;
		if (null != mBlock) {
			parserV4 = BlockLevelTokenStreamTrackerV4.getASN1ParserForBlock((BlockV4)mBlock);
		}
		if (null == parserV4) {
			return;
		}
		...
		if (null != mBlock) {
			components = parserV4.pr_special_AlternativeTypeLists().list;
