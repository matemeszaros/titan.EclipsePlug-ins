 ...
 */
public final class ASN1_Sequence_Type_V4 extends ASN1_Sequence_Type {

	public ASN1_Sequence_Type_V4(final Block aBlockV4) {
		super(aBlockV4);
	}

	@Override
	public IASN1Type newInstance() {
		return new ASN1_Sequence_Type_V4(mBlock);
	}

	@Override
	protected void parseBlockSequence() {
