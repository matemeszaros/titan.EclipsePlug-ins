 ...
 * */
public final class External_Type extends ASN1Type implements IReferencingType {
	private static final String TEMPLATENOTALLOWED = "{0} cannot be used for type `EXTERNAL''";
