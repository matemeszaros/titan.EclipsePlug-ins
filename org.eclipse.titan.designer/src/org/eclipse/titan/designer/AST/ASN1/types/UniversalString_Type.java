 ...
 * */
public final class UniversalString_Type extends ASN1Type {

	private static final String UNIVERSALSTRINGVALUEEXPECTED = "Universal string value was expected";

	@Override
	public Type_type getTypetype() {
		return Type_type.TYPE_UNIVERSALSTRING;
	}

	@Override
	public IASN1Type newInstance() {
		return new UniversalString_Type();
	}
	...
	public StringBuilder getProposalDescription(final StringBuilder builder) {
		return builder.append("universal string");
	}
}
