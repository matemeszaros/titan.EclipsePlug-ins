 ...
 */
public abstract class ASN1_Integer_Type extends ASN1Type {
	...
	private static final String LARGEINTEGERLOWERERROR = "Using a large integer value ({0})"
			+ " as the lower boundary of a length restriction is not supported";
	private static final String LARGEINTEGERUPPERERROR = "Using a large integer value ({0})"
			+ " as the upper boundary of a length restriction is not supported";
	...
	protected abstract void parseBlockInt();
