 ...
 * */
public final class VideotexString_Type extends ASN1Type {

	private static final String VIDEOTEXSTRINGVALUEEXPECTED = "Videotex string value was expected";

	@Override
	public Type_type getTypetype() {
		return Type_type.TYPE_VIDEOTEXSTRING;
	}

	@Override
	public IASN1Type newInstance() {
		return new VideotexString_Type();
	}
	...
	public StringBuilder getProposalDescription(final StringBuilder builder) {
		return builder.append("videotex string");
	}
}
