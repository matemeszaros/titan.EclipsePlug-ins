 ...
 * */
public final class ModuloExpression extends Expression_Value {
	private static final String FIRSTOPERANDERROR = "The first operand of the `mod' operation should be an integer value";
	private static final String SECONDOPERANDERROR = "The second operand of the `mod' operation should be an integer value";
	private static final String ZEROOPERANDERROR = "The second operand of operation `mod' should not be zero";

	private final Value value1;
	private final Value value2;

	public ModuloExpression(final Value value1, final Value value2) {
		this.value1 = value1;
		this.value2 = value2;
	...
	public Operation_type getOperationType() {
		return Operation_type.MODULO_OPERATION;
	}
