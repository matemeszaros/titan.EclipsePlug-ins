 ...
 * */
public final class Bit2StrExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `bit2str' operation should be a bitstring value";

	private final Value value;

	public Bit2StrExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.BIT2STR_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("bit2str(").append(value.createStringRepresentation()).append(')');
	...
	public IValue evaluateValue(final CompilationTimeStamp timestamp, final Expected_Value_type expectedValue,
		...
		case BITSTRING_VALUE:
			...
			lastValue = new Charstring_Value(tempBitstring);
