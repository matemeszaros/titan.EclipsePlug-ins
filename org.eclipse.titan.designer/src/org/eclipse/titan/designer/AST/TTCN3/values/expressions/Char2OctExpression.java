 ...
 * */
public final class Char2OctExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `char2oct' operation should be a charstring value";

	private final Value value;

	public Char2OctExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.CHAR2OCT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		final StringBuilder builder = new StringBuilder();
		builder.append("char2oct(").append(value.createStringRepresentation()).append(')');
	...
	public static String char2oct(final String charString) {
		...
		for (int i = 0; i < bytes.length; i++) {
			temp = bytes[i];
			builder.append((char) BitstringUtilities.hexdigitToChar(temp / 16));
			builder.append((char) BitstringUtilities.hexdigitToChar(temp % 16));
		}
		return builder.toString();
	}
