 ...
 * */
public final class Oct2BitExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `oct2bit' operation should be an octetstring value";

	private final Value value;

	public Oct2BitExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.OCT2BIT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		final StringBuilder builder = new StringBuilder();
		builder.append("oct2bit(").append(value.createStringRepresentation()).append(')');
