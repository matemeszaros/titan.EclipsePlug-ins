 ...
 * */
public final class Bit2OctExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `bit2oct' operation should be a bitstring value";

	private final Value value;

	public Bit2OctExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.BIT2OCT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("bit2oct(").append(value.createStringRepresentation()).append(')');
	...
	public static String bit2oct(final String bitString) {
		String string1 = Bit2HexExpression.bit2hex(bitString);
