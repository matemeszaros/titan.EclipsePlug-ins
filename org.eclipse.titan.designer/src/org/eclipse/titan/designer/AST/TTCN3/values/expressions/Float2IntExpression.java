 ...
 * */
public final class Float2IntExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `float2int' operation should be a float value";
	private static final String OPERANDERROR2 = "{0} can not be used as operand of the `float2int'' operation";

	private final Value value;

	public Float2IntExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.FLOAT2INT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("float2int(").append(value.createStringRepresentation()).append(')');
