 ...
 * */
public final class NotExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `not' operation should be a boolean value";

	private final Value value;

	public NotExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.NOT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("not(").append(value.createStringRepresentation()).append(')');
