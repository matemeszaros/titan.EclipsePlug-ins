...
public final class GetStringencodingExpression extends Expression_Value {
	...
	public String createStringRepresentation() {
		final String representation = value.createStringRepresentation();

		final StringBuilder builder = new StringBuilder(representation.length() + 20);
		builder.append("get_stringencoding(").append(representation).append(')');
