 ...
 * */
public final class DecodeBase64Expression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `decode_base64' operation should be a charstring value";

	private final Value value;

	public DecodeBase64Expression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.DECODE_BASE64_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		final StringBuilder builder = new StringBuilder();
		builder.append("decode_base64(").append(value.createStringRepresentation()).append(')');
	...
	public IValue evaluateValue(final CompilationTimeStamp timestamp, final Expected_Value_type expectedValue,
		...
		case CHARSTRING_VALUE:
			String tempBitstring = ((Charstring_Value) last).getValue();
	...
	public static String calculateValue(final String charString) {
		//TODO: reimplement
