 ...
 * */
public final class Oct2HexExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `oct2hex' operation should be an octetstring value";

	private final Value value;

	public Oct2HexExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.OCT2HEX_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("oct2hex(").append(value.createStringRepresentation()).append(')');
