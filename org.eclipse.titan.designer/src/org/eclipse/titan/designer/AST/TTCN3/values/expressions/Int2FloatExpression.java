 ...
 * */
public final class Int2FloatExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `int2float' operation should be an integer value";

	private final Value value;

	public Int2FloatExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.INT2FLOAT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("int2float(").append(value.createStringRepresentation()).append(')');
