 ...
 * */
public final class Bit2IntExpression extends Expression_Value {
	private static final String OPERANDERROR1 = "The operand of the `bit2int' operation should be a bitstring value";

	private final Value value;

	public Bit2IntExpression(final Value value) {
		this.value = value;
	...
	public String createStringRepresentation() {
		...
		builder.append("bit2int(").append(value.createStringRepresentation()).append(')');
