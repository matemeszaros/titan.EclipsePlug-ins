 ...
 * */
public final class Xor4bExpression extends Expression_Value {
	private static final String FIRSTOPERANDERROR = "The first operand of the `xor4b' operation should be a binary string value";
	private static final String SECONDOPERANDERROR = "The second operand of the `xor4b' operation should be a binary string value";
	private static final String SAMEOPERANDERROR = "The operands of operation `xor4b' should be of the same type";
	private static final String SAMEOPERANDLENGTHERROR = "The operands must have the same length";

	private final Value value1;
	private final Value value2;

	public Xor4bExpression(final Value value1, final Value value2) {
		this.value1 = value1;
		this.value2 = value2;
	...
	public Operation_type getOperationType() {
		return Operation_type.XOR4B_OPERATION;
	}
	...
	/**
	 * Calculates the binary xor -ing of two strings.
	 * 
	 * @param str1
