 ...
 * */
public final class Oct2StrExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `oct2str' operation should be an octetstring value";

	private final Value value;

	public Oct2StrExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.OCT2STR_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("oct2str(").append(value.createStringRepresentation()).append(')');
