 ...
 * */
public final class Int2StrExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `int2str' operation should be an integer value";

	private final Value value;

	public Int2StrExpression(final Value value) {
		this.value = value;
	...
	public String createStringRepresentation() {
		...
		builder.append("int2str(").append(value.createStringRepresentation()).append(')');
