 ...
 * */
public final class Hex2StrExpression extends Expression_Value {
	private static final String OPERANDERROR = "The operand of the `hex2str' operation should be a hexstring value";

	private final Value value;

	public Hex2StrExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.HEX2STR_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		final StringBuilder builder = new StringBuilder();
		builder.append("hex2str(").append(value.createStringRepresentation()).append(')');
	...
	public IValue evaluateValue(final CompilationTimeStamp timestamp, final Expected_Value_type expectedValue,
		...
		case HEXSTRING_VALUE:
			...
			lastValue = new Charstring_Value(temp);
