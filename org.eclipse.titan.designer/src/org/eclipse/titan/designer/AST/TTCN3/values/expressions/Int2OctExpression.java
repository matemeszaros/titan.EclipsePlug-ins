 ...
 * */
public final class Int2OctExpression extends Expression_Value {
	private static final String OPERANDERROR1 = "The first operand of the `int2oct' operation should be an integer value";
	private static final String OPERANDERROR2 = "The first operand of the `int2oct' operation should not be negative";
	private static final String OPERANDERROR3 = "The second operand of the `int2oct' operation should be an integer value";
	private static final String OPERANDERROR4 = "The second operand of the `int2oct' operation should not be negative";
	private static final String OPERANDERROR5 = "Value {0} does not fit in length {1}";
	private static final String OPERANDERROR6 = "Using a large integer value ({0}) as the second operand of `int2oct'' is not supported";

	private final Value value1;
	private final Value value2;

	public Int2OctExpression(final Value value1, final Value value2) {
		this.value1 = value1;
		this.value2 = value2;
	...
	public Operation_type getOperationType() {
		return Operation_type.INT2OCT_OPERATION;
	}
