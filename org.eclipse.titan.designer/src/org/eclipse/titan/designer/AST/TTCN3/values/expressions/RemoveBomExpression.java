 ...
 * */
public final class RemoveBomExpression extends Expression_Value {
	private static final String OPERANDERROR1 = "The operand of the `remove_bom' operation should be an octetstring value";
	private static final String OPERANDERROR2 = "The operand of the `remove_bom' operation shall consist of octets within the range 00..7F";

	private final Value value;

	public RemoveBomExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.REMOVE_BOM_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("remove_bom(").append(value.createStringRepresentation()).append(')');
