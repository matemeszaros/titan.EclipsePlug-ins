 ...
 * */
public final class Start_Port_Statement extends Statement {
	private static final String FULLNAMEPART = ".portreference";
	private static final String STATEMENT_NAME = "start port";

	private final Reference portReference;

	public Start_Port_Statement(final Reference portReference) {
	...
	public Statement_type getType() {
		return Statement_type.S_START_PORT;
	}
