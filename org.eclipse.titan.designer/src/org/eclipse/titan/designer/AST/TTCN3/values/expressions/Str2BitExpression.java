 ...
 * */
public final class Str2BitExpression extends Expression_Value {
	private static final String OPERANDERROR1 = "The operand of the `str2bit' operation should be a charstring value";
	private static final String OPERANDERROR2 = "The operand of the `str2bit' operation can contain only binary digits";

	private final Value value;

	public Str2BitExpression(final Value value) {
		this.value = value;
	...
	public Operation_type getOperationType() {
		return Operation_type.STR2BIT_OPERATION;
	}

	@Override
	public String createStringRepresentation() {
		StringBuilder builder = new StringBuilder();
		builder.append("str2bit(").append(value.createStringRepresentation()).append(')');
