 ...
 * */
public final class Kill_Statement extends Statement {
	private static final String FULLNAMEPART = ".componentreference";
	private static final String STATEMENT_NAME = "kill";

	private final Value componentReference;

	public Kill_Statement(final Value componentReference) {
