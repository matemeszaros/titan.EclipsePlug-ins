...
public class PPDirectiveTokenFactory4 implements TokenFactory<CommonToken>{
	public static final TokenFactory<CommonToken> DEFAULT = new PPDirectiveTokenFactory4();
	protected final boolean copyText;
	Token token;

	public PPDirectiveTokenFactory4() {
		this.copyText = false;
		this.token = new CommonToken(Token.EOF);
	}

	public PPDirectiveTokenFactory4 (boolean copyText, Token token) { 
