lexer grammar TTCN3Lexer4;
import TTCN3BaseLexer4;
...
/*------------------------------------------- Keywords -------------------------------------------*/
  ...
  INT2BIT: 'int2bit';	INT2CHAR: 'int2char';	INT2FLOAT: 'int2float';	INT2HEX: 'int2hex';
  INT2OCT: 'int2oct';	INT2STR: 'int2str';	INT2UNICHAR: 'int2unichar';
